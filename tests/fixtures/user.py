...
@pytest_asyncio.fixture
async def create_test_user(db: AsyncSession) -> User: # test_user
    user = User(
        username=fake.user_name(),
        email=fake.email(),
        role="customer",
...
async def test_create_seller(client: AsyncClient, db: AsyncSession):
    register_data = {
        "first_name": fake.first_name(),
        "last_name": fake.last_name(),
        "username": fake.user_name(),
...
@pytest_asyncio.fixture(scope="function")
async def test_create_customer(client: AsyncClient, db: AsyncSession):
    register_data = {
        "first_name": fake.first_name(),
        "last_name": fake.last_name(),
        "username": fake.user_name(),
...
@pytest_asyncio.fixture(scope="function")
async def test_create_support(client: AsyncClient, db: AsyncSession):
    register_data = {
        "first_name": fake.first_name(),
        "last_name": fake.last_name(),
        "username": fake.user_name(),
