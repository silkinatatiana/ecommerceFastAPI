...
class TestChat:
    ...
    async def test_get_all_chats(
        self, client_support: AsyncClient, db: AsyncSession, test_chat, create_test_user
    ):
    ...
    async def test_get_all_chats_negative(
        self, client_any_support: AsyncClient, db: AsyncSession
    ):
    ...
    async def test_chat_by_id(
        self, client_support: AsyncClient, db: AsyncSession, fake_chat_id
    ):
